...
class Classifier:
    ...
    def normalizeColumn(self, columnNumber):
        ...
        for i in range(len(self.data)):
            ...
            listOfFirstNum.append(self.data[i][1][columnNumber])

        median = self.getMedian(listOfFirstNum)

        asd = self.getAbsoluteStandardDeviation(listOfFirstNum, median)

        self.medianAndDeviation.append((median, asd))

        for i in range(len(self.data)):

            self.data[i][1][columnNumber] = (self.data[i][1][columnNumber]
